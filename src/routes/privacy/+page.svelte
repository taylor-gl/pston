<svelte:head>
  <title>Privacy Policy - People Saying Their Own Names</title>
  <meta name="description" content="Privacy Policy for People Saying Their Own Names" />
</svelte:head>

<div class="page-content">
  <strong>Privacy Policy</strong>
  <p>
    This privacy policy applies to the peoplesayingtheirownnames.com app (hereby referred to as
    "Application") for mobile devices that was created by Taylor G. Lunt (hereby referred to as
    "Service Provider") as an Open Source service. This service is intended for use "AS IS".
  </p>
  ...
  <p>
    ...
    full name, user id. The information that the Service Provider request will be retained by them
  ...
  <p>
    ...
    provided via the Application, please contact them at taylor@taylor.gl and they will respond in a
    reasonable time.
  </p>
  ...
  <div>
    ...
    <p>
      ...
      enforce this Policy by instructing their children never to provide personally identifiable
      information through the Application and/or Services without their permission. If you have
      reason to believe that a child has provided personally identifiable information to the Service
      Provider through the Application and/or Services, please contact the Service Provider
      (taylor@taylor.gl) so that they will be able to take the necessary actions. You must also be
  ...
  <br />
  <p>This privacy policy is effective as of 2025-07-01</p>
  ...
  <p>
    ...
    the practices, please contact the Service Provider via email at taylor@taylor.gl.
  </p>
  <hr />
  <p>
